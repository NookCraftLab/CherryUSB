> **NookCraftLab 维护分支**：基于上游 CherryUSB v1.6.1，用于 NookCraftLab 键盘固件项目。
>
> **维护者**：Lion ([@Lion-nice](https://github.com/Lion-nice)) · **组织**：[NookCraftLab](https://github.com/NookCraftLab)
